...
import { selectAllWatchedlistMovies } from "../../store/storeSlice";

const Watched = () => {
  const watchedlistMovies = useSelector(selectAllWatchedlistMovies);
  return (
      ...
      <div className="container">
        <div className="header">
          ...
          <div className="count-pill">
            {watchedlistMovies.length}{" "}
            {watchedlistMovies.length < 2 ? "Movie" : "Movies"}
          </div>
        </div>
